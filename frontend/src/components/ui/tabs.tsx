    ...
    >
      ...
      <TabsPrimitive.Indicator
        className={cn(
          ...
          variant === "underline"
            ? "z-10 bg-primary data-[orientation=horizontal]:h-[2px] data-[orientation=vertical]:w-[2px] data-[orientation=vertical]:-translate-x-px data-[orientation=horizontal]:translate-y-px"
            : "-z-1 rounded-lg bg-background shadow-sm/5 dark:bg-input",
        )}
