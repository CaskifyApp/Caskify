...
export namespace db {
	...
	export class ConnectionTestParams {
	    profile: profiles.Profile;
	    password: string;
	
	    static createFrom(source: any = {}) {
	        return new ConnectionTestParams(source);
	    }
	...
	export class CreateSchemaParams {
	    profileId: string;
	    database: string;
	    name: string;
	
	    static createFrom(source: any = {}) {
	        return new CreateSchemaParams(source);
	    }
	...
	export class CreateTableParams {
	    ...
	    static createFrom(source: any = {}) {
	        return new CreateTableParams(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.schema = source["schema"];
	        this.name = source["name"];
	        this.columns = this.convertValues(source["columns"], CreateTableColumnInput);
	    }
	...
	export class DropDatabaseParams {
	    ...
	    static createFrom(source: any = {}) {
	        return new DropDatabaseParams(source);
	    }
	...
	export class DropSchemaParams {
	    profileId: string;
	    database: string;
	    name: string;
	
	    static createFrom(source: any = {}) {
	        return new DropSchemaParams(source);
	    }
	...
	export class DropTableParams {
	    ...
	    static createFrom(source: any = {}) {
	        return new DropTableParams(source);
	    }
	...
	export class RenameTableParams {
	    ...
	    static createFrom(source: any = {}) {
	        return new RenameTableParams(source);
	    }
